...
<div class="header">
            ...
            <fieldset class="row1">
                <legend> Bloodbank Details
                </legend>
                <p>
                <label>BloodBank's Email *
                </label>
